...
import * as Actions from '../redux/tictactoe/tictactoe.actions.v2'
import Game from "../components/tictactoe/Game";

const TicTacToePageV2 = ({
...
const mapStateToProps = state => {
    const {tictactoe: {v2: {loading, board, next, active, scoreboard, accuracy, moves}}} = state;
    return {
        loading: loading,
        board: board,
        next: next,
